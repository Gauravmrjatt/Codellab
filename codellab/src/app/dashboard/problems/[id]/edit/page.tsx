  ...
  useEffect(() => {
      const fetchProblem = async () => {
          try {
              ...
              // Normalize data
              const inputs = data.inputs?.map((inp: any) => ({
                name: inp.name,
                type: inp.type,
              ...
              form.reset({
                  ...
                  functionName: data.functionName || "solve",
                  inputs,
                  output,
                  testCases
              });
  ...
  return (
    <div className="space-y-8">
      {/* EVERYTHING ELSE BELOW IS 100% UNCHANGED
          EXCEPT JSON parsing normalization */}
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Update the coding challenge.</p>
        </div>
      </div>
